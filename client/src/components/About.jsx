const About = () => {
  ...
  return (
    <section
      id="about"
      className="relative min-h-screen overflow-hidden bg-white py-16 lg:py-20 text-gray-900 dark:bg-gray-950 dark:text-gray-100"
    >
        ...
        <div className="lg:w-1/2">
          <div className="grid gap-6 sm:grid-cols-3">
            {highlights.map((item) => (
              <div
                key={item.label}
                className="group rounded-2xl border border-blue-100 bg-white/80 p-6 text-center shadow-lg shadow-blue-100/40 transition-transform duration-300 hover:-translate-y-1 dark:border-gray-800 dark:bg-gray-900/80 dark:shadow-none"
              >
          ...
          <div className="mt-10 rounded-3xl bg-gradient-to-r from-blue-600 via-purple-500 to-pink-500 p-[1px]">
