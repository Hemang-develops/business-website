...
const PersonalizedCoachingCTA = () => {
  ...
  return (
    <section
      id="coaching"
      className="relative min-h-screen overflow-hidden bg-gradient-to-br from-purple-900/30 via-gray-950 to-black py-16 lg:py-24 text-white"
    >
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="w-full max-w-sm rounded-3xl border border-white/10 bg-white/10 p-8 backdrop-blur">
            ...
            <div className="mt-4 flex items-baseline gap-3">
              <p className="text-4xl font-bold">1,111 $</p>
            ...
            <div className="grid auto-rows-fr gap-5">
              {quickLinks.map((link) => (
                ...
                >
                  ...
                  <span className="mt-4 inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.3em] text-white/60 transition group-hover:text-pink-200">
                    Explore
